        ...
        <div class="box-body with-border">
            <div class="row">
                ...
                <div class="col-md-2 text-right mr-3">
                    <a href="{{ route('admin.payments') }}"><i class="fa fa-refresh"></i>&nbsp;Yenile</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-default">
                ...
                <div class="box-body" >
                    <div class="row">
                        <form action="{{ route('admin.payments') }}" method="GET" id="form">
                            <div class="col-md-12">
                                <div class="col-md-1" style="padding-top: 8px"><strong>Filtrele : </strong></div>
                                    <div class="col-md-2">
                                        <select name="vendor_id" class="form-control vendorIdFilter" id="vendor_id_filter">
...
{{--                                </div>--}}
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a href="{{ route('admin.payments') }}" class="btn btn-sm btn-danger">Temizle</a>
                                </div>
